...
import type { UserProfile, IntimacyLevel, DurationPreference } from '@/types'
...
export const useAuthStore = create<AuthStore>((set) => ({
  ...
  setOnboardingPrefs: ({ intimacyLevel, durationPreference, partnerName }) =>
    set({ intimacyLevel, durationPreference, partnerName }),
  ...
  signOut: () => set({ user: null, isOnboarded: false, intimacyLevel: null, durationPreference: null, partnerName: null }),
}))
